...
public class LISessionManager {
    ...
    public void init(Activity activity,
                     Scope scope, AuthListener callback, boolean showGoToAppStoreDialog, @StyleRes int dialogStyle) {
        //check if LI
        if (!LIAppVersion.isLIAppCurrent(ctx)) {
            AppStore.goAppStore(activity, showGoToAppStoreDialog, dialogStyle);
            return;
        }
