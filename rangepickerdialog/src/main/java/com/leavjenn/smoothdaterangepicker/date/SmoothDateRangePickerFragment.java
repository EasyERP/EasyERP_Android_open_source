...
public class SmoothDateRangePickerFragment extends DialogFragment implements OnClickListener,
     ...
     */
    public static SmoothDateRangePickerFragment newInstance(OnDateRangeSetListener callBack, int year, int monthOfYear, int dayOfMonth, int yearTo, int monthOfYearTo, int dayOfMonthTo) {
        SmoothDateRangePickerFragment ret = new SmoothDateRangePickerFragment();
        ret.initialize(callBack, year, monthOfYear, dayOfMonth, yearTo, monthOfYearTo, dayOfMonthTo);
        return ret;
    }
    ...
    public static SmoothDateRangePickerFragment newInstance(OnDateRangeSetListener callBack) {
        ...
        ret.initialize(callBack, todayCal.get(Calendar.YEAR), todayCal.get(Calendar.MONTH),
                todayCal.get(Calendar.DAY_OF_MONTH), todayCal.get(Calendar.YEAR), todayCal.get(Calendar.MONTH), todayCal.get(Calendar.DAY_OF_MONTH));
        return ret;
    }

    public void initialize(OnDateRangeSetListener callBack, int year, int monthOfYear, int dayOfMonth, int yearTo, int monthOfYearTo, int dayOfMonthTo) {
        mCallBack = callBack;
        mCalendar.set(Calendar.YEAR, year);
        mCalendar.set(Calendar.MONTH, monthOfYear);
        mCalendar.set(Calendar.DAY_OF_MONTH, dayOfMonth);
        mCalendarEnd.set(Calendar.YEAR, yearTo);
        mCalendarEnd.set(Calendar.MONTH, monthOfYearTo);
        mCalendarEnd.set(Calendar.DAY_OF_MONTH, dayOfMonthTo);
