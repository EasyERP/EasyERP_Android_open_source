...
public class LibrariesRepository implements LibrariesContract.LibrariesModel {
    ...
    public ArrayList<LibraryInfo> getLibraries() {
        ...
        dependencies.add(new LibraryInfo("SmoothDateRangePicker",     "0.2.0",    "leavjenn", "Apache License 2.0", "https://github.com/leavjenn/SmoothDateRangePicker"));
        ...
        dependencies.add(new LibraryInfo("LinkedIn Android SDK",      "1.1.4",    "LinkedIn", "LinkedIn License", "https://developer.linkedin.com/downloads#androidsdk"));
