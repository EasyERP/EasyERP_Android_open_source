...
import com.thinkmobiles.easyerp.data.model.leads.LeadWorkflow;
...
public class ResponseGetLeadDetails implements Parcelable {
    ...
    */
    ...
    public static final Parcelable.Creator<ResponseGetLeadDetails> CREATOR = new Parcelable.Creator<ResponseGetLeadDetails>() {
        @Override
