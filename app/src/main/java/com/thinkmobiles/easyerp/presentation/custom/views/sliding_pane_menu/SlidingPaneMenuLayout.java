package com.thinkmobiles.easyerp.presentation.custom.views.sliding_pane_menu;
...
/**
 * Created by samson on 19.01.17.
 */

public class SlidingPaneMenuLayout extends ViewGroup {

    private static final String TAG = "SlidingPaneMenuLayout";
    ...
    private SlidingPaneMenuLayout.PanelSlideListener mPanelSlideListener;

    final SlidingPaneMenuDragHelper mDragHelper;
    ...
    final ArrayList<SlidingPaneMenuLayout.DisableLayerRunnable> mPostedRunnables =
            new ArrayList<SlidingPaneMenuLayout.DisableLayerRunnable>();

    static final SlidingPaneMenuLayout.SlidingPanelLayoutImpl IMPL;

    static {
        final int deviceVersion = Build.VERSION.SDK_INT;
        if (deviceVersion >= 17) {
            IMPL = new SlidingPaneMenuLayout.SlidingPanelLayoutImplJBMR1();
        } else if (deviceVersion >= 16) {
            IMPL = new SlidingPaneMenuLayout.SlidingPanelLayoutImplJB();
        } else {
            IMPL = new SlidingPaneMenuLayout.SlidingPanelLayoutImplBase();
        }
    }
    ...
    public SlidingPaneMenuLayout(Context context) {
        this(context, null);
    }

    public SlidingPaneMenuLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingPaneMenuLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        ViewCompat.setAccessibilityDelegate(this, new SlidingPaneMenuLayout.AccessibilityDelegate());
        ViewCompat.setImportantForAccessibility(this, ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_YES);

        mDragHelper = SlidingPaneMenuDragHelper.create(this, 0.5f, new SlidingPaneMenuLayout.DragHelperCallback());
    ...
    public void setPanelSlideListener(SlidingPaneMenuLayout.PanelSlideListener listener) {
    ...
    protected void onDetachedFromWindow() {
        ...
        for (int i = 0, count = mPostedRunnables.size(); i < count; i++) {
            final SlidingPaneMenuLayout.DisableLayerRunnable dlr = mPostedRunnables.get(i);
            dlr.run();
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            final View child = getChildAt(i);
            final SlidingPaneMenuLayout.LayoutParams lp = (SlidingPaneMenuLayout.LayoutParams) child.getLayoutParams();
            ...
            if (lp.width == SlidingPaneMenuLayout.LayoutParams.WRAP_CONTENT) {
                childWidthSpec = View.MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin,
                        View.MeasureSpec.AT_MOST);
            } else if (lp.width == SlidingPaneMenuLayout.LayoutParams.MATCH_PARENT) {
                childWidthSpec = View.MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin,
            ...
            int childHeightSpec;
            if (lp.height == SlidingPaneMenuLayout.LayoutParams.WRAP_CONTENT) {
                childHeightSpec = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight, View.MeasureSpec.AT_MOST);
            } else if (lp.height == SlidingPaneMenuLayout.LayoutParams.MATCH_PARENT) {
        ...
        if (mDragHelper.getViewDragState() != SlidingPaneMenuDragHelper.STATE_IDLE && !canSlide) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        final boolean isLayoutRtl = isLayoutRtlSupport();
        if (isLayoutRtl) {
            mDragHelper.setEdgeTrackingEnabled(SlidingPaneMenuDragHelper.EDGE_RIGHT);
        } else {
            mDragHelper.setEdgeTrackingEnabled(SlidingPaneMenuDragHelper.EDGE_LEFT);
        }
        final int width = r - l;
        ...
        if (mFirstLayout) {
            if (mCanSlide) {
                ...
                if (((SlidingPaneMenuLayout.LayoutParams) mSlideableView.getLayoutParams()).dimWhenOffset) {
    ...
    void onPanelDragged(int newLeft) {
        ...
        final boolean isLayoutRtl = isLayoutRtlSupport();
        final SlidingPaneMenuLayout.LayoutParams lp = (SlidingPaneMenuLayout.LayoutParams) mSlideableView.getLayoutParams();
    ...
    private void dimChildView(View v, float mag, int fadeColor) {
        final SlidingPaneMenuLayout.LayoutParams lp = (SlidingPaneMenuLayout.LayoutParams) v.getLayoutParams();
        ...
        if (mag > 0 && fadeColor != 0) {
            ...
            final SlidingPaneMenuLayout.DisableLayerRunnable dlr = new SlidingPaneMenuLayout.DisableLayerRunnable(v);
    ...
    private void parallaxOtherViews(float slideOffset) {
        final boolean isLayoutRtl = isLayoutRtlSupport();
        final SlidingPaneMenuLayout.LayoutParams slideLp = (SlidingPaneMenuLayout.LayoutParams) mSlideableView.getLayoutParams();
    ...
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
        return new SlidingPaneMenuLayout.LayoutParams();
    }

    @Override
    protected ViewGroup.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof ViewGroup.MarginLayoutParams
                ? new SlidingPaneMenuLayout.LayoutParams((ViewGroup.MarginLayoutParams) p)
                : new SlidingPaneMenuLayout.LayoutParams(p);
    }

    @Override
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof SlidingPaneMenuLayout.LayoutParams && super.checkLayoutParams(p);
    }

    @Override
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new SlidingPaneMenuLayout.LayoutParams(getContext(), attrs);
    }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        SlidingPaneMenuLayout.SavedState ss = new SlidingPaneMenuLayout.SavedState(superState);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof SlidingPaneMenuLayout.SavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }

        SlidingPaneMenuLayout.SavedState ss = (SlidingPaneMenuLayout.SavedState) state;
    ...
    private class DragHelperCallback extends SlidingPaneMenuDragHelper.Callback {
        ...
        public void onViewDragStateChanged(int state) {
            if (mDragHelper.getViewDragState() == SlidingPaneMenuDragHelper.STATE_IDLE) {
                if (mSlideOffset == 0) {
                    updateObscuredViewsVisibility(mSlideableView);
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            final SlidingPaneMenuLayout.LayoutParams lp = (SlidingPaneMenuLayout.LayoutParams) releasedChild.getLayoutParams();
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(SlidingPaneMenuLayout.LayoutParams source) {
            super(source);
    ...
    static class SavedState extends AbsSavedState {
        ...
        public static final Creator<SlidingPaneMenuLayout.SavedState> CREATOR = ParcelableCompat.newCreator(
                new ParcelableCompatCreatorCallbacks<SlidingPaneMenuLayout.SavedState>() {
                    @Override
                    public SlidingPaneMenuLayout.SavedState createFromParcel(Parcel in, ClassLoader loader) {
                        return new SlidingPaneMenuLayout.SavedState(in, loader);
                    }

                    @Override
                    public SlidingPaneMenuLayout.SavedState[] newArray(int size) {
                        return new SlidingPaneMenuLayout.SavedState[size];
                    }
                });
    }

    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(SlidingPaneMenuLayout parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPaneMenuLayout.SlidingPanelLayoutImpl {
        @Override
        public void invalidateChildRegion(SlidingPaneMenuLayout parent, View child) {
            ViewCompat.postInvalidateOnAnimation(parent, child.getLeft(), child.getTop(),
                    child.getRight(), child.getBottom());
        }
    }

    static class SlidingPanelLayoutImplJB extends SlidingPaneMenuLayout.SlidingPanelLayoutImplBase {
        /*
    ...
    static class SlidingPanelLayoutImplJBMR1 extends SlidingPaneMenuLayout.SlidingPanelLayoutImplBase {
        @Override
        public void invalidateChildRegion(SlidingPaneMenuLayout parent, View child) {
            ViewCompat.setLayerPaint(child, ((SlidingPaneMenuLayout.LayoutParams) child.getLayoutParams()).dimPaint);
        }
    }
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(SlidingPaneMenuLayout.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(SlidingPaneMenuLayout.class.getName());
        }
    ...
    private class DisableLayerRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mChildView.getParent() == SlidingPaneMenuLayout.this) {
